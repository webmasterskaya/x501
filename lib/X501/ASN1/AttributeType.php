...
class AttributeType
{
    ...
    const MAP_OID_TO_NAME = [
        ...
        '1.2.643.3.131.1.1' => ['ИНН', 'INN'],
        '1.2.643.100.1' => ['ОГРН', 'OGRN'],
        '1.2.643.100.3' => ['СНИЛС', 'SNILS'],
        '1.2.840.113549.1.9.2' => ['UN', 'Unsructured Name','UnsructuredName', 'Неструктурированное имя']
    ];
